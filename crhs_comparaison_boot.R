...
save(boot_res, file = "rdata/boot_res1.rda")
print("End of bootstrap computation")

load("rdata/all_rda_data/boot_res.rda")
load("rdata/all_rda_data/boot_res1.rda")
...
boot.ci(air.boot, type = c("norm", "basic", "perc"), index = 2)
air.boot$t0
